...
const CartTabBottom = ({navigation, route}) => {
    ...
    if(item == '' || item == undefined || item == null){
        AxiosUtil.getToken().then((data) => {
            ...
            axios.get('http://10.0.2.2:3001/cart', {
                ...
                console.log("Cart error 2: "+error + " ")
            })
        })
    }
    // if(myCart.length == 0){
    ...
    //                 shippingFee={0}
    //                 total={ + 0}
    //                 onPress={() => navigation.navigate("Checkout", {fee: {subTotal: 0, shippingFee: 0, total:  0}})}
    //             />
    //         </View>
    //     )
    // }
